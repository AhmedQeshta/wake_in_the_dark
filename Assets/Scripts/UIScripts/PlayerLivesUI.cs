...
public class PlayerLivesUI : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        originalColors = new Color[lifeIcons.Length];
        fadeRoutines = new Coroutine[lifeIcons.Length];

        /*
         * At scene start all configured life icons begin visible.
         */
        displayedLives = lifeIcons.Length;
    ...
    public void UpdateLives(int currentLives)
    {
        ...
        if (currentLives < displayedLives)
            for (int i = currentLives; i < displayedLives; i++)
                FadeOutLife(i);
        /*
         * If lives are ever restored, show those icons again.
         */
    ...
    private void FadeOutLife(int index)
    {
        ...
        /*
         * Stop an old fade on this icon if one is somehow already running.
         */
