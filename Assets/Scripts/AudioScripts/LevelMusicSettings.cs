...
public class LevelMusicSettings : MonoBehaviour
{
    ...
    [Tooltip("Time used when changing from another level's music.")]
    [SerializeField, Min(0f)] private float crossfadeDuration = 0.8f;


    [Tooltip("If enabled, Reset Level starts this music again from the beginning.")]
    [SerializeField] private bool restartOnReload = false;
    ...
    public bool RestartOnReload => restartOnReload;
